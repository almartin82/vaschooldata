...
Python wrapper for Virginia school enrollment data.

This is a thin rpy2 wrapper around the [vaschooldata](https://github.com/almartin82/vaschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `vaschooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/vaschooldata")

# Then install the Python package
pip install pyvaschooldata
```
...
# Fetch one year
df = va.fetch_enr(2025)

# Fetch multiple years
df_multi = va.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
