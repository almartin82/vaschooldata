...
# This vignette requires network access to VDOE servers
# Set eval=FALSE for R CMD check, but the prebuilt version in doc/ shows full output
...
This vignette explores Virginia's public school enrollment data, surfacing key trends and demographic patterns across 10 years of data (2016-2025).
