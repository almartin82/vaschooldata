...
Fetch and analyze Virginia school data from the Virginia Department of Education (VDOE) in R or Python. Includes enrollment data for every school and division in Virginia (2016-2024) and graduation rates for every high school (2019-2023).
...
Virginia educates nearly **1.25 million students** across 132 school divisions and graduates over **90,000 seniors** each year. This package provides 9 years of enrollment data and 5 years of graduation data directly from VDOE. Here are fifteen stories hiding in the data:
...
See the [full vignette](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks.html) for all 15 stories with charts.
