...
Fetch and analyze Virginia school data from the Virginia Department of
Education (VDOE) in R or Python. Includes enrollment data for every
school and division in Virginia (2016-2024) and graduation rates for
every high school (2019-2023).
...
directly from VDOE. Here are fifteen stories hiding in the data:
...
trend](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/grad-trend-chart-1.png)

Virginia graduation rate trend
...
![Diploma type
breakdown](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/diploma-breakdown-chart-1.png)

Diploma type breakdown
...
![Richmond City graduation
trend](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/richmond-grad-chart-1.png)

Richmond City graduation trend
...
![Northern Virginia graduation
rates](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/nova-grad-chart-1.png)

Northern Virginia graduation rates
...
![Dropout rate
trend](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/covid-dropout-chart-1.png)
...
![Hampton Roads graduation
rates](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/hampton-roads-grad-chart-1.png)

Hampton Roads graduation rates
...
![Southwest Virginia graduation
rates](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/swva-grad-chart-1.png)

Southwest Virginia graduation rates
...
![Largest Virginia high
schools](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/largest-schools-chart-1.png)

Largest Virginia high schools
...
![Non-graduates by
outcome](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/dropout-count-chart-1.png)

Non-graduates by outcome
...
trends](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/alexandria-chart-1.png)

Alexandria City High School trends
...
![Fairfax County graduation
trend](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/fairfax-grad-chart-1.png)

Fairfax County graduation trend
...
![Biggest graduation rate
improvements](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/improvements-chart-1.png)

Biggest graduation rate improvements
...
![Division graduation rate
extremes](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/division-gap-chart-1.png)

Division graduation rate extremes
...
![Cohort size vs
graduates](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks_files/figure-html/five-year-summary-chart-1.png)

Cohort size vs graduates
...
| `grade_level`                                        | PK, K, 01-12, UG, TOTAL                                                   |
| `subgroup`                                           | Demographic group (total_enrollment, white, black, hispanic, asian, etc.) |
| `n_students`                                         | Enrollment count                                                          |
| `pct`                                                | Percentage of total                                                       |
| `is_state`, `is_district`, `is_campus`, `is_charter` | Entity flags                                                              |

### Graduation (`fetch_graduation()`)

| Column                         | Description                                                                   |
|--------------------------------|-------------------------------------------------------------------------------|
| `end_year`                     | Cohort year                                                                   |
| `division_name`, `school_name` | Names                                                                         |
| `graduation_rate`              | 4-year cohort graduation rate                                                 |
| `cohort_size`                  | Number of students in cohort                                                  |
| `total_graduates`              | Number who graduated                                                          |
| `dropout_rate`                 | Cohort dropout rate                                                           |
| `diploma_type`                 | advanced_studies, standard, ib, applied_studies, ged, isaep, certificate, all |
| `diploma_count`                | Count for each diploma type                                                   |
| `is_state`, `is_school`        | Entity flags                                                                  |
...
requires CAPTCHA verification for enrollment data downloads. When this
happens, use `use_cache = TRUE` (default) to rely on locally cached
data. If no cache exists, download files manually from the [VDOE
enrollment
...
to import them. Graduation data is always available via the VDOE Open
Data Portal.

See the [full
vignette](https://almartin82.github.io/vaschooldata/articles/enrollment_hooks.html)
for all 15 stories with charts.
